...
from google.cloud.video.stitcher_v1.services.video_stitcher_service import VideoStitcherServiceAsyncClient
...
@pytest.mark.parametrize("client_class", [
    VideoStitcherServiceClient, VideoStitcherServiceAsyncClient
])
@mock.patch.object(VideoStitcherServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(VideoStitcherServiceClient))
@mock.patch.object(VideoStitcherServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(VideoStitcherServiceAsyncClient))
...
def test_create_cdn_key(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.create_cdn_key),
            '__call__') as call:
...
def test_list_cdn_keys(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_cdn_keys),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_cdn_keys_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, cdn_keys.CdnKey)
                   for i in results)
...
def test_get_cdn_key(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_cdn_key),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = cdn_keys.CdnKey(
            name='name_value',
...
def test_delete_cdn_key(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_cdn_key),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_update_cdn_key(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_cdn_key),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = cdn_keys.CdnKey(
            name='name_value',
...
def test_create_vod_session(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_vod_session),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_vod_session(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_vod_session),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = sessions.VodSession(
            name='name_value',
...
def test_list_vod_stitch_details_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, stitch_details.VodStitchDetail)
                   for i in results)
...
def test_get_vod_stitch_detail(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_vod_stitch_detail),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_vod_ad_tag_details_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, ad_tag_details.VodAdTagDetail)
                   for i in results)
...
def test_get_vod_ad_tag_detail(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_vod_ad_tag_detail),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_live_ad_tag_details_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, ad_tag_details.LiveAdTagDetail)
                   for i in results)
...
def test_get_live_ad_tag_detail(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_live_ad_tag_detail),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_slate(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_slate),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_slates(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_slates),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_slates_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, slates.Slate)
                   for i in results)
...
def test_get_slate(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_slate),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = slates.Slate(
            name='name_value',
...
def test_update_slate(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_slate),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = slates.Slate(
            name='name_value',
...
def test_delete_slate(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_slate),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
def test_create_live_session(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_live_session),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_live_session(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_live_session),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = sessions.LiveSession(
            name='name_value',
...
def test_create_cdn_key_rest(request_type):
    ...
    request_init["cdn_key"] = {'google_cdn_key': {'private_key': b'private_key_blob', 'key_name': 'key_name_value'}, 'akamai_cdn_key': {'token_key': b'token_key_blob'}, 'media_cdn_key': {'private_key': b'private_key_blob', 'key_name': 'key_name_value'}, 'name': 'name_value', 'hostname': 'hostname_value'}
...
def test_create_cdn_key_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("cdnKeyId", )) & set(("parent", "cdnKey", "cdnKeyId", )))
...
def test_create_cdn_key_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.VideoStitcherServiceRestInterceptor, "post_create_cdn_key") as post, \
         mock.patch.object(transports.VideoStitcherServiceRestInterceptor, "pre_create_cdn_key") as pre:
        ...
        client.create_cdn_key(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_cdn_key_rest_bad_request(transport: str = 'rest', request_type=video_stitcher_service.CreateCdnKeyRequest):
    client = VideoStitcherServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_cdn_keys_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.VideoStitcherServiceRestInterceptor, "post_list_cdn_keys") as post, \
         mock.patch.object(transports.VideoStitcherServiceRestInterceptor, "pre_list_cdn_keys") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = video_stitcher_service.ListCdnKeysResponse.to_json(video_stitcher_service.ListCdnKeysResponse())
        ...
        client.list_cdn_keys(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_cdn_keys_rest_bad_request(transport: str = 'rest', request_type=video_stitcher_service.ListCdnKeysRequest):
    client = VideoStitcherServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_cdn_key_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.VideoStitcherServiceRestInterceptor, "post_get_cdn_key") as post, \
         mock.patch.object(transports.VideoStitcherServiceRestInterceptor, "pre_get_cdn_key") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.get_cdn_key(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_cdn_key_rest_bad_request(transport: str = 'rest', request_type=video_stitcher_service.GetCdnKeyRequest):
    client = VideoStitcherServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_cdn_key_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.VideoStitcherServiceRestInterceptor, "pre_delete_cdn_key") as pre:
        pre.assert_not_called()
        ...
        client.delete_cdn_key(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_delete_cdn_key_rest_bad_request(transport: str = 'rest', request_type=video_stitcher_service.DeleteCdnKeyRequest):
    client = VideoStitcherServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_cdn_key_rest(request_type):
    ...
    request_init["cdn_key"] = {'google_cdn_key': {'private_key': b'private_key_blob', 'key_name': 'key_name_value'}, 'akamai_cdn_key': {'token_key': b'token_key_blob'}, 'media_cdn_key': {'private_key': b'private_key_blob', 'key_name': 'key_name_value'}, 'name': 'projects/sample1/locations/sample2/cdnKeys/sample3', 'hostname': 'hostname_value'}
    request = request_type(**request_init)
...
def test_update_cdn_key_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("updateMask", )) & set(("cdnKey", "updateMask", )))
...
def test_update_cdn_key_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.VideoStitcherServiceRestInterceptor, "post_update_cdn_key") as post, \
         mock.patch.object(transports.VideoStitcherServiceRestInterceptor, "pre_update_cdn_key") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.update_cdn_key(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_update_cdn_key_rest_bad_request(transport: str = 'rest', request_type=video_stitcher_service.UpdateCdnKeyRequest):
    client = VideoStitcherServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_vod_session_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "vodSession", )))
...
def test_create_vod_session_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.VideoStitcherServiceRestInterceptor, "post_create_vod_session") as post, \
         mock.patch.object(transports.VideoStitcherServiceRestInterceptor, "pre_create_vod_session") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.create_vod_session(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_vod_session_rest_bad_request(transport: str = 'rest', request_type=video_stitcher_service.CreateVodSessionRequest):
    client = VideoStitcherServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_vod_session_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.VideoStitcherServiceRestInterceptor, "post_get_vod_session") as post, \
         mock.patch.object(transports.VideoStitcherServiceRestInterceptor, "pre_get_vod_session") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.get_vod_session(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_vod_session_rest_bad_request(transport: str = 'rest', request_type=video_stitcher_service.GetVodSessionRequest):
    client = VideoStitcherServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_vod_stitch_details_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = video_stitcher_service.ListVodStitchDetailsResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_list_vod_stitch_details_rest_required_fields(request_type=video_stitcher_service.ListVodStitchDetailsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_vod_stitch_details._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_vod_stitch_details_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.VideoStitcherServiceRestInterceptor, "post_list_vod_stitch_details") as post, \
         mock.patch.object(transports.VideoStitcherServiceRestInterceptor, "pre_list_vod_stitch_details") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = video_stitcher_service.ListVodStitchDetailsResponse.to_json(video_stitcher_service.ListVodStitchDetailsResponse())
        ...
        client.list_vod_stitch_details(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_vod_stitch_details_rest_bad_request(transport: str = 'rest', request_type=video_stitcher_service.ListVodStitchDetailsRequest):
    client = VideoStitcherServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_vod_stitch_detail_rest_required_fields(request_type=video_stitcher_service.GetVodStitchDetailRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_vod_stitch_detail._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_vod_stitch_detail_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.VideoStitcherServiceRestInterceptor, "post_get_vod_stitch_detail") as post, \
         mock.patch.object(transports.VideoStitcherServiceRestInterceptor, "pre_get_vod_stitch_detail") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = stitch_details.VodStitchDetail.to_json(stitch_details.VodStitchDetail())
        ...
        client.get_vod_stitch_detail(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_vod_stitch_detail_rest_bad_request(transport: str = 'rest', request_type=video_stitcher_service.GetVodStitchDetailRequest):
    client = VideoStitcherServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_vod_ad_tag_details_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = video_stitcher_service.ListVodAdTagDetailsResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_list_vod_ad_tag_details_rest_required_fields(request_type=video_stitcher_service.ListVodAdTagDetailsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_vod_ad_tag_details._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_vod_ad_tag_details_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.VideoStitcherServiceRestInterceptor, "post_list_vod_ad_tag_details") as post, \
         mock.patch.object(transports.VideoStitcherServiceRestInterceptor, "pre_list_vod_ad_tag_details") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = video_stitcher_service.ListVodAdTagDetailsResponse.to_json(video_stitcher_service.ListVodAdTagDetailsResponse())
        ...
        client.list_vod_ad_tag_details(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_vod_ad_tag_details_rest_bad_request(transport: str = 'rest', request_type=video_stitcher_service.ListVodAdTagDetailsRequest):
    client = VideoStitcherServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_vod_ad_tag_detail_rest_required_fields(request_type=video_stitcher_service.GetVodAdTagDetailRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_vod_ad_tag_detail._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_vod_ad_tag_detail_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.VideoStitcherServiceRestInterceptor, "post_get_vod_ad_tag_detail") as post, \
         mock.patch.object(transports.VideoStitcherServiceRestInterceptor, "pre_get_vod_ad_tag_detail") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = ad_tag_details.VodAdTagDetail.to_json(ad_tag_details.VodAdTagDetail())
        ...
        client.get_vod_ad_tag_detail(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_vod_ad_tag_detail_rest_bad_request(transport: str = 'rest', request_type=video_stitcher_service.GetVodAdTagDetailRequest):
    client = VideoStitcherServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_live_ad_tag_details_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = video_stitcher_service.ListLiveAdTagDetailsResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_list_live_ad_tag_details_rest_required_fields(request_type=video_stitcher_service.ListLiveAdTagDetailsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_live_ad_tag_details._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_live_ad_tag_details_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.VideoStitcherServiceRestInterceptor, "post_list_live_ad_tag_details") as post, \
         mock.patch.object(transports.VideoStitcherServiceRestInterceptor, "pre_list_live_ad_tag_details") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = video_stitcher_service.ListLiveAdTagDetailsResponse.to_json(video_stitcher_service.ListLiveAdTagDetailsResponse())
        ...
        client.list_live_ad_tag_details(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_live_ad_tag_details_rest_bad_request(transport: str = 'rest', request_type=video_stitcher_service.ListLiveAdTagDetailsRequest):
    client = VideoStitcherServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_live_ad_tag_detail_rest_required_fields(request_type=video_stitcher_service.GetLiveAdTagDetailRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_live_ad_tag_detail._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_live_ad_tag_detail_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.VideoStitcherServiceRestInterceptor, "post_get_live_ad_tag_detail") as post, \
         mock.patch.object(transports.VideoStitcherServiceRestInterceptor, "pre_get_live_ad_tag_detail") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = ad_tag_details.LiveAdTagDetail.to_json(ad_tag_details.LiveAdTagDetail())
        ...
        client.get_live_ad_tag_detail(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_live_ad_tag_detail_rest_bad_request(transport: str = 'rest', request_type=video_stitcher_service.GetLiveAdTagDetailRequest):
    client = VideoStitcherServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_slate_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("slateId", )) & set(("parent", "slateId", "slate", )))
...
def test_create_slate_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.VideoStitcherServiceRestInterceptor, "post_create_slate") as post, \
         mock.patch.object(transports.VideoStitcherServiceRestInterceptor, "pre_create_slate") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.create_slate(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_slate_rest_bad_request(transport: str = 'rest', request_type=video_stitcher_service.CreateSlateRequest):
    client = VideoStitcherServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_slates_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.VideoStitcherServiceRestInterceptor, "post_list_slates") as post, \
         mock.patch.object(transports.VideoStitcherServiceRestInterceptor, "pre_list_slates") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = video_stitcher_service.ListSlatesResponse.to_json(video_stitcher_service.ListSlatesResponse())
        ...
        client.list_slates(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_slates_rest_bad_request(transport: str = 'rest', request_type=video_stitcher_service.ListSlatesRequest):
    client = VideoStitcherServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_slate_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.VideoStitcherServiceRestInterceptor, "post_get_slate") as post, \
         mock.patch.object(transports.VideoStitcherServiceRestInterceptor, "pre_get_slate") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.get_slate(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_slate_rest_bad_request(transport: str = 'rest', request_type=video_stitcher_service.GetSlateRequest):
    client = VideoStitcherServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_slate_rest(request_type):
    ...
    request_init["slate"] = {'name': 'projects/sample1/locations/sample2/slates/sample3', 'uri': 'uri_value'}
    request = request_type(**request_init)
...
def test_update_slate_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("updateMask", )) & set(("slate", "updateMask", )))
...
def test_update_slate_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.VideoStitcherServiceRestInterceptor, "post_update_slate") as post, \
         mock.patch.object(transports.VideoStitcherServiceRestInterceptor, "pre_update_slate") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.update_slate(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_update_slate_rest_bad_request(transport: str = 'rest', request_type=video_stitcher_service.UpdateSlateRequest):
    client = VideoStitcherServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_slate_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.VideoStitcherServiceRestInterceptor, "pre_delete_slate") as pre:
        pre.assert_not_called()
        ...
        client.delete_slate(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_delete_slate_rest_bad_request(transport: str = 'rest', request_type=video_stitcher_service.DeleteSlateRequest):
    client = VideoStitcherServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_live_session_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["live_session"] = {'name': 'name_value', 'play_uri': 'play_uri_value', 'source_uri': 'source_uri_value', 'default_ad_tag_id': 'default_ad_tag_id_value', 'ad_tag_map': {}, 'ad_tag_macros': {}, 'client_ad_tracking': True, 'default_slate_id': 'default_slate_id_value', 'stitching_policy': 1, 'manifest_options': {'include_renditions': [{'bitrate_bps': 1167, 'codecs': 'codecs_value'}], 'bitrate_order': 1}, 'stream_id': 'stream_id_value'}
    request = request_type(**request_init)
...
def test_create_live_session_rest_required_fields(request_type=video_stitcher_service.CreateLiveSessionRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_live_session._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_live_session_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("parent", "liveSession", )))
...
def test_create_live_session_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.VideoStitcherServiceRestInterceptor, "post_create_live_session") as post, \
         mock.patch.object(transports.VideoStitcherServiceRestInterceptor, "pre_create_live_session") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.create_live_session(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_live_session_rest_bad_request(transport: str = 'rest', request_type=video_stitcher_service.CreateLiveSessionRequest):
    client = VideoStitcherServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_live_session_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.VideoStitcherServiceRestInterceptor, "post_get_live_session") as post, \
         mock.patch.object(transports.VideoStitcherServiceRestInterceptor, "pre_get_live_session") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.get_live_session(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_live_session_rest_bad_request(transport: str = 'rest', request_type=video_stitcher_service.GetLiveSessionRequest):
    client = VideoStitcherServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.VideoStitcherServiceGrpcTransport, transports.VideoStitcherServiceGrpcAsyncIOTransport])
def test_video_stitcher_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
