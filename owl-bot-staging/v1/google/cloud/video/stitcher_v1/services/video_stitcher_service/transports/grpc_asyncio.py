...
from .base import VideoStitcherServiceTransport, DEFAULT_CLIENT_INFO
...
class VideoStitcherServiceGrpcAsyncIOTransport(VideoStitcherServiceTransport):
    ...
    @property
    def create_live_config(self) -> Callable[
    ...
    @property
    def list_live_configs(self) -> Callable[
    ...
    @property
    def get_live_config(self) -> Callable[
    ...
    @property
    def delete_live_config(self) -> Callable[
