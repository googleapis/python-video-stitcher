...
class VideoStitcherServiceClient(metaclass=VideoStitcherServiceClientMeta):
    ...
    def cdn_key_path(project: str,location: str,cdn_key: str,) -> str:
        ...
        return "projects/{project}/locations/{location}/cdnKeys/{cdn_key}".format(project=project, location=location, cdn_key=cdn_key, )
    ...
    @staticmethod
    def live_ad_tag_detail_path(project: str,location: str,live_session: str,live_ad_tag_detail: str,) -> str:
        """Returns a fully-qualified live_ad_tag_detail string."""
        return "projects/{project}/locations/{location}/liveSessions/{live_session}/liveAdTagDetails/{live_ad_tag_detail}".format(project=project, location=location, live_session=live_session, live_ad_tag_detail=live_ad_tag_detail, )

    @staticmethod
    def parse_live_ad_tag_detail_path(path: str) -> Dict[str,str]:
        """Parses a live_ad_tag_detail path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/liveSessions/(?P<live_session>.+?)/liveAdTagDetails/(?P<live_ad_tag_detail>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def live_config_path(project: str,location: str,live_config: str,) -> str:
        """Returns a fully-qualified live_config string."""
        return "projects/{project}/locations/{location}/liveConfigs/{live_config}".format(project=project, location=location, live_config=live_config, )
    ...
    def live_session_path(project: str,location: str,live_session: str,) -> str:
        ...
        return "projects/{project}/locations/{location}/liveSessions/{live_session}".format(project=project, location=location, live_session=live_session, )
    ...
    def slate_path(project: str,location: str,slate: str,) -> str:
        ...
        return "projects/{project}/locations/{location}/slates/{slate}".format(project=project, location=location, slate=slate, )
    ...
    @staticmethod
    def vod_ad_tag_detail_path(project: str,location: str,vod_session: str,vod_ad_tag_detail: str,) -> str:
        """Returns a fully-qualified vod_ad_tag_detail string."""
        return "projects/{project}/locations/{location}/vodSessions/{vod_session}/vodAdTagDetails/{vod_ad_tag_detail}".format(project=project, location=location, vod_session=vod_session, vod_ad_tag_detail=vod_ad_tag_detail, )

    @staticmethod
    def parse_vod_ad_tag_detail_path(path: str) -> Dict[str,str]:
        """Parses a vod_ad_tag_detail path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/vodSessions/(?P<vod_session>.+?)/vodAdTagDetails/(?P<vod_ad_tag_detail>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def vod_session_path(project: str,location: str,vod_session: str,) -> str:
        """Returns a fully-qualified vod_session string."""
        return "projects/{project}/locations/{location}/vodSessions/{vod_session}".format(project=project, location=location, vod_session=vod_session, )
    ...
    @staticmethod
    def vod_stitch_detail_path(project: str,location: str,vod_session: str,vod_stitch_detail: str,) -> str:
        """Returns a fully-qualified vod_stitch_detail string."""
        return "projects/{project}/locations/{location}/vodSessions/{vod_session}/vodStitchDetails/{vod_stitch_detail}".format(project=project, location=location, vod_session=vod_session, vod_stitch_detail=vod_stitch_detail, )

    @staticmethod
    def parse_vod_stitch_detail_path(path: str) -> Dict[str,str]:
        """Parses a vod_stitch_detail path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/vodSessions/(?P<vod_session>.+?)/vodStitchDetails/(?P<vod_stitch_detail>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def list_vod_stitch_details(self,
    ...
    def get_vod_stitch_detail(self,
    ...
    def list_vod_ad_tag_details(self,
    ...
    def get_vod_ad_tag_detail(self,
    ...
    def list_live_ad_tag_details(self,
    ...
    def get_live_ad_tag_detail(self,
