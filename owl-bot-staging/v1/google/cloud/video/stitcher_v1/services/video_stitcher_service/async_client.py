...
class VideoStitcherServiceAsyncClient:
    ...
    get_transport_class = functools.partial(type(VideoStitcherServiceClient).get_transport_class, type(VideoStitcherServiceClient))
    ...
    async def create_vod_session(self,
    ...
    async def get_vod_session(self,
    ...
    async def list_vod_stitch_details(self,
    ...
    async def get_vod_stitch_detail(self,
    ...
    async def list_vod_ad_tag_details(self,
    ...
    async def get_vod_ad_tag_detail(self,
    ...
    async def list_live_ad_tag_details(self,
    ...
    async def get_live_ad_tag_detail(self,
    ...
    async def get_live_session(self,
    ...
    async def create_live_config(self,
    ...
    async def list_live_configs(self,
    ...
    async def delete_live_config(self,
