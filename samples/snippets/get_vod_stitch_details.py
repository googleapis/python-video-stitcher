...
Example usage:
    python get_vod_stitch_details.py --project_number <project-number> --location <location> --session_id <session-id> --stitch_details_id <stitch-details-id>
"""

# [START video_stitcher_get_vod_stitch_details]
...
def get_vod_stitch_details(project_number, location, session_id, stitch_details_id):
...
# [END video_stitcher_get_vod_stitch_details]
