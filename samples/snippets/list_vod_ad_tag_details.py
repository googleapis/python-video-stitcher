...
"""Google Cloud Video Stitcher sample for listing the ad tag details for a video on demand (VOD) session.
Example usage:
    python list_vod_ad_tag_details.py --project_number <project-number> --location <location> --session_id <session-id>
"""
...
def list_vod_ad_tag_details(project_number, location, session_id):
...
if __name__ == "__main__":
    ...
    list_vod_ad_tag_details(args.project_number, args.location, args.session_id)
