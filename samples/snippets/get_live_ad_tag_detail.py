...
Example usage:
    python get_live_ad_tag_detail.py --project_number <project-number> --location <location> --session_id <session-id> --ad_tag_details_id <ad-tag-details-id>
"""
...
def get_live_ad_tag_detail(project_number, location, session_id, ad_tag_details_id):
